...
class Detection:
# get the model and load it into the memory- obj detection model
    ...
    def __init__(self,object,img):
        ...
        for i in range(len(boxes)):
            ...
            if classes[i] == 1 and scores[i] > self.threshold:
                ...
                cv2.putText(img,"safe",(box[1],box[0]-10),cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255,255,255), 1)
        txt="hey" + str(len(self.pick))
        cv2.putText(img,txt,(200,200),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.5,(255,255,255),1)
        ...
        for i in range(len(self.pick)-1):
            ...
            for j in range(i+1,len(self.pick)):
                ...
                if dist<100:
                    ...
                    cv2.putText(img,"violation",(xA1,yA1-10),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.3,(255,255,255),1)
                    cv2.putText(img,"violation",(xA2,yA2-10),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.3,(255,255,255),1)
                
                #else:
                    #cv2.rectangle(img,(xA1,yA1),(xB1,yB1),(0,255,0),2)
                    #cv2.rectangle(img,(xA2,yA2),(xB2,yB2),(0,255,0),2)
                    #cv2.putText(img,"safe",(xA1,yA1-10),cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255,255,255), 1)
                    #cv2.putText(img,"safe",(xA2,yA2-10),cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255,255,255), 1)
